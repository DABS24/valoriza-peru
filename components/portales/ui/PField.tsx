...
function Ayuda({ hint, error }: { hint?: string; error?: string }) {
  ...
  return <p className={cn("mt-1.5 text-xs", error ? "text-portal-danger" : "text-portal-muted")}>{error ?? hint}</p>;
}
...
export const PInput = forwardRef<HTMLInputElement, InputHTMLAttributes<HTMLInputElement> & CommonProps & { leadingIcon?: ReactNode }>(
...
export const PPassword = forwardRef<HTMLInputElement, InputHTMLAttributes<HTMLInputElement> & CommonProps>(
...
export const PSelect = forwardRef<HTMLSelectElement, SelectHTMLAttributes<HTMLSelectElement> & CommonProps & { children: ReactNode }>(
...
export const PTextarea = forwardRef<HTMLTextAreaElement, TextareaHTMLAttributes<HTMLTextAreaElement> & CommonProps>(
